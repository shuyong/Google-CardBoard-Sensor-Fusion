...
class So3Util {
	...
	private: static Vector3d temp;
	private: static Vector3d sO3FromTwoVecN; // 矢量n = a * b
	private: static Vector3d sO3FromTwoVecA; // 矢量a
	private: static Vector3d sO3FromTwoVecB; // 矢量b
	private: static Vector3d sO3FromTwoVecRotationAxis;	// 旋转轴
	...
	private: static Vector3d rotationPiAboutAxisTemp; // 为rotationPiAboutAxis函数准备的临时变量。

	// 根据旋转前后的矢量a, b求出旋转矩阵
	public: static void sO3FromTwoVec(const Vector3d& a, const Vector3d& b, Matrix3x3d& result) {
	...
	private: static void rotationPiAboutAxis(const Vector3d& v, Matrix3x3d& result) {
	...
	public: static void sO3FromMu(const Vector3d& w, Matrix3x3d& result) {
	...
	public: static void generatorField(const int i, Matrix3x3d& pos, Matrix3x3d& result) {
		result.set( i         , 0,  0.0D                   );
...
// FIXME: Init static member.
// 有重入性的问题。多线程应用慎用。
Vector3d So3Util::temp;
Vector3d So3Util::sO3FromTwoVecN; // 矢量n = a * b
Vector3d So3Util::sO3FromTwoVecA; // 矢量a
Vector3d So3Util::sO3FromTwoVecB; // 矢量b
Vector3d So3Util::sO3FromTwoVecRotationAxis;
Matrix3x3d So3Util::sO3FromTwoVec33R1;
Matrix3x3d So3Util::sO3FromTwoVec33R2;
Vector3d So3Util::muFromSO3R2;
Vector3d So3Util::rotationPiAboutAxisTemp; // 为rotationPiAboutAxis函数准备的临时变量。
